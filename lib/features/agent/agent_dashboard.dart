...
class _AgentDashboardState extends State<AgentDashboard> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      const AgentBookingsPage(), // <-- Replaced placeholder
...
// --- ENHANCED DASHBOARD OVERVIEW WIDGET ---
...
class DashboardOverview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final int activeHostels = userData['active_hostels'] ?? 0;
    final int totalBookings = userData['total_bookings'] ?? 0;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          // 1. THE STACK (Header + Floating Card)
          Stack(
            clipBehavior: Clip.none,
            alignment: Alignment.topCenter,
            children: [
              _buildCurvedHeader(size, name),
              Positioned(
                top: 140,
                left: 20,
                right: 20,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildActionTile(Icons.add_circle_outline, "Add New Hostel", "List a new property"),
                _buildActionTile(Icons.verified_user_outlined, "Verify Profile", "Increase trust score"),
              ],
            ),
          ),
  ...
  Widget _buildCurvedHeader(Size size, String name) {
    return Container(
      height: 220,
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            bottom: -20, right: -20,
            child: Icon(Icons.blur_on, size: 150, color: Colors.white.withValues(alpha: 0.1)),
          ),
          Padding(
  ...
  Widget _buildFluidStatCard(String title, String value, IconData icon, Color c1, Color c2) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: c1.withValues(alpha: 0.3), blurRadius: 10, offset: const Offset(0, 5)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
